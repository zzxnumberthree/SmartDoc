...
| Streaming | Named `token`, `complete`, and `error` SSE events; POST Web client with buffered parsing | No browser, reconnect, heartbeat, load, or end-to-end cancellation proof |
